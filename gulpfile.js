...
gulp.task('scripts', function() {
  return gulp.src(jsFiles)
    .pipe(isDev ? sourcemaps.init() : new PassThrough({ objectMode: true })) // Initialize sourcemaps in dev
    ...
    .pipe(isDev ? sourcemaps.write('.') : new PassThrough({ objectMode: true })) // Write sourcemaps in dev
