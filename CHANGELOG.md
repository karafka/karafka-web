...
- [Fix] Omit the received offset from the republish flash when the broker reports it as invalid, and redirect to the topic that received the message instead of back to the source topic (Pro).
