...
## 1.0.0 (Unreleased)
- [Enhancement] Link the partition in the Explorer's single-message metadata table to the partition view in the Explorer, matching the offset/partition linking added to the Errors detail view (#1179).
