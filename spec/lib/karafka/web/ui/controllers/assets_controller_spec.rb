...
# Technically this spec does not test controller but routes but since it makes similar requests
# to other specs we've added it here.
RSpec.describe Karafka::Web::Ui::Controllers::BaseController, type: :controller do
