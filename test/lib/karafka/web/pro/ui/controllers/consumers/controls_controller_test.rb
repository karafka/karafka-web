...
describe_current do
  ...
  describe "#index" do
    ...
    # The default consumer process (shinra:1:1) is subscribed to the "default", "test2" and
    # "visits" topics and is tagged "#8cbff36". We exercise filtering on each allowed attribute,
