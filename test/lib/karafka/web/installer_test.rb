...
describe_current do
  ...
  describe "#install" do
    let(:run) { described_class.new.install }
  ...
  describe "#migrate" do
    let(:run) { described_class.new.migrate }
  ...
  describe "#reset" do
    let(:run) { described_class.new.reset }
  ...
  describe "#uninstall" do
    let(:run) { described_class.new.uninstall }
  ...
  describe "#enable!" do
    let(:run) { described_class.new.enable! }
