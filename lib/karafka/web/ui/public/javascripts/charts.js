...
function saveCurrentDisabledDatasets() {
  let charts = document.querySelectorAll('.chartjs-line')
...
function refreshCharts(new_doc) {
  var charts = new_doc.querySelectorAll('.chartjs-line')
...
function renderCharts() {
  var charts = document.getElementsByClassName('chartjs-line');
