...
/*! Source: lib/karafka/web/ui/public/javascripts/components/action_confirmation_manager.js */class ActionConfirmationManager{constructor(e="Are you sure?"){this.confirmationMessage=e,this.init()}init(){this.bindActionsConfirmations()}bindActionsConfirmations(){var i=document.getElementsByClassName("confirm-action");for(let t=0;t<i.length;t++){var s=i[t];let e="click";"FORM"===s.nodeName&&(e="submit"),s.addEventListener(e,e=>{window.confirm(this.confirmationMessage)||e.preventDefault()})}}}
/*! Source: lib/karafka/web/ui/public/javascripts/components/alerts.js */class AlertsManager{constructor(){this.setupCloseButtons()}setupCloseButtons(){document.querySelectorAll(".alert .close-alert").forEach(t=>{t.addEventListener("click",()=>{var e=t.closest(".alert");e&&this.closeAlert(e)})})}closeAlert(i){i.style.opacity="1",i.style.transition="opacity 0.3s ease-out",i.style.opacity="0",setTimeout(()=>{var e,t=i.closest(".col-span-12");(!t||((e=t.cloneNode(!0)).querySelector(".alert").remove(),e.innerHTML.trim())?i:t).remove()},300)}}
...
/*! Source: lib/karafka/web/ui/public/javascripts/components/button_lock_manager.js */class ButtonLockManager{constructor(){this.init()}init(){this.bindLockableButtons()}bindLockableButtons(){document.querySelectorAll(".btn-lockable").forEach(s=>{s.addEventListener("click",e=>{var t=s.closest("form"),i=()=>{s.disabled=!0,Array.from(s.childNodes).some(e=>e.nodeType===Node.TEXT_NODE&&0<e.textContent.trim().length)&&s.insertAdjacentText("beforeend","..."),document.addEventListener("turbo:before-visit",()=>{s.disabled=!0},{once:!0}),document.querySelectorAll(".modal").forEach(e=>{e.classList.add("modal-locked")})};t?(t.addEventListener("submit",i,{once:!0}),t.addEventListener("turbo:submit-end",()=>{s.disabled=!0},{once:!0})):i()})})}}
...
/*! Source: lib/karafka/web/ui/public/javascripts/components/live_poll.js */var livePollTimer=null,oldDOM=null,datePicker=null,startURL=window.location.href;function initLivePolling(){null==localStorage.karafkaLivePoll&&(localStorage.karafkaLivePoll="enabled")}function isFormActive(){var e,t=document.activeElement,i=["INPUT","TEXTAREA","SELECT","BUTTON","FIELDSET"].includes(t.tagName);return i&&"BUTTON"===t.tagName&&!t.closest("form")?(e=window.mouseX||0,document.elementFromPoint(e,window.mouseY||0)===t):i}function isEditableFormVisible(){var e;for(e of document.querySelectorAll("form"))if(!e.classList.contains("filter-form"))if(e&&"none"!==window.getComputedStyle(e).display&&"hidden"!==window.getComputedStyle(e).visibility&&null!==e.offsetParent)if(0<Array.from(e.querySelectorAll('input:not([type="hidden"]):not([readonly]):not([disabled]), textarea:not([readonly]):not([disabled]), select:not([disabled])')).filter(e=>{var t=window.getComputedStyle(e);return null!==e.offsetParent&&"none"!==t.display&&"hidden"!==t.visibility&&!e.closest('[aria-hidden="true"]')}).length)return!0;return!1}function isFilterFormDirty(){var e,t,i;for(e of document.querySelectorAll("form.filter-form")){for(t of e.querySelectorAll('input[type="text"]'))if(t.value!==t.defaultValue)return!0;for(i of e.querySelectorAll("select"))if(Array.from(i.options).some(e=>e.selected!==e.defaultSelected))return!0}return!1}function isElementClickable(e){return!!("A"===e.tagName||"BUTTON"===e.tagName||"INPUT"===e.tagName&&("button"===e.type||"submit"===e.type)||e.hasAttribute("onclick")||"function"==typeof e.onclick||"SPAN"===e.tagName&&e.closest(".tab-container")||e.closest("button")||e.closest("a"))}function isUserHoveringOverClickable(){var e=window.mouseX||0,e=document.elementFromPoint(e,window.mouseY||0);return e&&isElementClickable(e)}function isAnyTextSelected(){var e="";return void 0!==window.getSelection?e=window.getSelection().toString():void 0!==document.selection&&"Text"==document.selection.type&&(e=document.selection.createRange().text),""!=e}function isCollapsingHappening(){return 0<document.querySelectorAll(".collapsing").length}function isPollingPossible(e=!1){return!isFormActive()&&!isEditableFormVisible()&&!(isFilterFormDirty()||isUserHoveringOverClickable()||isAnyTextSelected()||isOffsetLookupCalendarVisible()||isAnyModalOpen()||isCollapsingHappening()||isTurboOperating()||e&&startURL!=window.location.href)}function isAnyModalOpen(){var e;for(e of document.querySelectorAll("dialog"))if(e.open)return!0;return!1}function bindPollingButtonClick(){var e=document.getElementById("live-poll");null!=e&&e.addEventListener("click",handleLivePollingButtonClick)}function handleLivePollingButtonClick(){toggleLivePollState(),setLivePollButton(),setPollingListener()}function toggleLivePollState(){"enabled"==localStorage.karafkaLivePoll?localStorage.karafkaLivePoll="disabled":localStorage.karafkaLivePoll="enabled"}function setLivePollButton(){null!=(selector=document.getElementById("live-poll"))&&("enabled"==localStorage.karafkaLivePoll?(selector.classList.remove("!text-base-content/70"),selector.classList.remove("hover:!text-primary-content")):(selector.classList.add("!text-base-content/70"),selector.classList.add("hover:!text-primary-content")))}function checkResponse(e){if(e.ok)return e;throw e}function refreshPage(e){if(!isPollingPossible())return!1;var t,e=(new DOMParser).parseFromString(e,"text/html"),i=e.getElementById("content"),s=e.getElementById("content-header"),r=e.getElementById("content-breadcrumbs");oldDOM!=i.innerHTML&&(t=document.querySelectorAll(".chartjs").length,0==i.querySelectorAll(".chartjs").length||0==t?(document.getElementById("content").replaceWith(i),document.getElementById("content-header").replaceWith(s),null!=r&&document.getElementById("content-breadcrumbs").replaceWith(r),addListeners()):(t=e.getElementById("refreshable"),document.getElementById("refreshable").replaceWith(t),refreshCharts(e)),oldDOM=i.innerHTML)}function showError(e){console.error(e)}function scheduleLivePoll(){null==oldDOM&&(oldDOM=document.getElementById("content").innerHTML);let e=parseInt(localStorage.karafkaTimeInterval)||5e3;e<1e3&&(localStorage.karafkaTimeInterval=5e3,e=5e3),livePollTimer=setTimeout(livePollCallback,e)}function livePollCallback(){clearTimeout(livePollTimer),livePollTimer=null,isPollingPossible(!1)?(startURL=window.location.href,fetch(window.location.href).then(checkResponse).then(e=>e.text()).then(refreshPage).catch(showError).finally(setPollingListener)):setPollingListener()}function setPollingListener(){var e=document.getElementById("live-poll"),t=localStorage.karafkaLivePoll;"disabled"==t||null==t||null==e?(clearTimeout(livePollTimer),livePollTimer=null):(clearTimeout(livePollTimer),scheduleLivePoll())}
/*! Source: lib/karafka/web/ui/public/javascripts/components/message_publish_manager.js */document.addEventListener("mousemove",function(e){window.mouseX=e.clientX,window.mouseY=e.clientY});class MessagePublishManager{constructor(){this.init()}init(){var e=document.getElementById("message-publish-form");if(!e)return!1;let t=e.querySelector('input[type="checkbox"][name="tombstone"]'),i=document.getElementById("payload"),s=document.getElementById("payload_file");if(!t||!i||!s)return!1;e=()=>this.updateState(t,i,s);e(),t.addEventListener("change",e),s.addEventListener("change",e)}updateState(e,t,i){var e=e.checked,s=i.files&&0<i.files.length;t.disabled=(i.disabled=e)||s}}
/*! Source: lib/karafka/web/ui/public/javascripts/components/message_republish_manager.js */class MessageRepublishManager{constructor(){this.init()}init(){var e=document.getElementById("message-republish-form");if(!e)return!1;let t=e.querySelector('select[name="target_topic"]'),i=document.getElementById("target_partition");if(!t||!i)return!1;this.updatePartitionValidation(t,i),t.addEventListener("change",()=>{this.updatePartitionValidation(t,i)})}updatePartitionValidation(e,t){var i,e=e.options[e.selectedIndex],e=parseInt(e.getAttribute("data-partitions"),10);!isNaN(e)&&0<e?(t.setAttribute("max",(e-1).toString()),i=parseInt(t.value,10),!isNaN(i)&&e<=i&&(t.value="")):t.setAttribute("max","10000")}}
/*! Source: lib/karafka/web/ui/public/javascripts/components/modal_opener.js */class ModalOpener{constructor(){this.init()}init(){document.querySelectorAll("[data-modal-open]").forEach(t=>{t.addEventListener("click",()=>{var e=document.getElementById(t.dataset.modalOpen);e&&e.showModal()})})}}
...
/*! Source: lib/karafka/web/ui/public/javascripts/components/time_ago_manager.js */class TimeAgoManager{constructor(){this.init()}init(){this.updateTimeAgo()}updateTimeAgo(){var e=document.querySelectorAll("time"),t=(0!=e.length&&(timeago.render(e),timeago.cancel()),document.getElementsByClassName("time-title"));for(let e=0;e<t.length;e++){var i=t[e],s=i.getAttribute("title");i.setAttribute("title",timeago.format(s))}}}
/*! Source: lib/karafka/web/ui/public/javascripts/components/timestamp_selector.js */class TimestampSelector{constructor(){this.init()}init(){let i=document.getElementById("timestamp-form");if(!i)return!1;i.closest(".dropdown").querySelector("button").addEventListener("click",()=>{setTimeout(()=>{i.querySelector("input").focus()},50)});let s=i.closest(".dropdown");i.addEventListener("submit",e=>{e.preventDefault();i.querySelector("button");s.classList.add("dropdown-open");var e=i.dataset.target,t=i.querySelector("input").value;window.location.href=e+"/"+t})}}
...
/*! Source: lib/karafka/web/ui/public/javascripts/application.js */function addListeners(){initLivePolling(),bindPollingButtonClick(),setLivePollButton(),setPollingListener(),hljs.highlightAll(),new TimeAgoManager,new PartitionRedirectManager,(new TabsManager).manageTabs(),manageCharts(),loadOffsetLookupDatePicker(),new BtnToggleManager,new BtnToggleManager(".btn-toggle-nav-collapsed","collapsed"),new ThemeManager,new ButtonLockManager,new ActionConfirmationManager,new ModalOpener,new PageTitleTracker,new SearchMetadataVisibilityManager,new SearchModalManager,new TimestampSelector,new AlertsManager,new MessageRepublishManager,new MessagePublishManager}document.addEventListener("turbo:visit",function(){turboIsOperating=!0}),document.addEventListener("turbo:before-fetch-request",function(){turboIsOperating=!0}),document.addEventListener("turbo:before-fetch-response",function(){turboIsOperating=!0}),document.addEventListener("turbo:load",function(){turboIsOperating=!1}),document.addEventListener("turbo:frame-load",function(){turboIsOperating=!1}),document.addEventListener("turbo:frame-render",function(){turboIsOperating=!1}),document.addEventListener("turbo:load",addListeners),Turbo.setProgressBarDelay(100)
