...
// If we have visible alerts we should not refresh the page as otherwise they would disappear
function alertsVisible() {
  const alerts = document.querySelectorAll('.col-span-12 .alert');
