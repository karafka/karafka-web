...
module Karafka
  module Web
    module Tracking
      module Consumers
        module Listeners
          # Listener that auto-tags the process with group.instance.id when static group memberships
          # are used. This improves debugging and allows tracking of processes despite different
          ...
          class StaticGroupMemberships < Base
