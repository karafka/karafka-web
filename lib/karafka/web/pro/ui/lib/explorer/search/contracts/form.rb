          ...
          module Explorer
            module Search
              module Contracts
                ...
                # consistency of the data but without providing detailed user error reporting as
                ...
                class Form < Web::Contracts::Base
                  ...
                  # Offset from which to start. We can require it even if we do not start from
                  ...
                  # We do not check here that partitions exist because when searching we just
