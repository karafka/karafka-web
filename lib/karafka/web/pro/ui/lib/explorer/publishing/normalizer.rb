    ...
    module Pro
      module Ui
        module Lib
          module Explorer
            module Publishing
              # Coerces the raw publish request params into a typed, symbol-keyed hash the rest of
              ...
              module Normalizer
                class << self
                  ...
                  # `params.bool` raises on missing keys, but the field is absent on the first form
                  ...
                  def uploaded_bytes(params)
                    ...
                    # Rewind so repeated normalization (e.g. the error re-render path) reads the
