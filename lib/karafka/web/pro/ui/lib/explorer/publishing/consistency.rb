        ...
        module Lib
          module Explorer
            module Publishing
              ...
              # (consume-side) deserializer. Running it over the bytes is a validity check: if
              # the deserializer raises, the payload does not meet what the topic's consumers want.
              #
              ...
              module Consistency
                ...
                class << self
                  ...
                  # @return [String, nil] error description when the payload is not consumable, or
