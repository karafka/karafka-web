        ...
        module Lib
          module Republishing
            ...
            module Contracts
              ...
              # the target topic's deserializer (delegated to {Publishing::Consistency}). Rules are
              # independent so all problems surface at once.
              #
              # @note Requires `target_partitions_count` and `source_message` in the data alongside
              ...
              class Form < Web::Contracts::Base
                ...
                # The payload must be consumable by the target topic's deserializer, unless skipped
                virtual do |data|
