    ...
    module Pro
      module Ui
        module Controllers
          module Explorer
            module Messages
              # Streams an existing message payload to the browser as a file, either raw or as the
              # deserialized-and-reserialized JSON export
              class ExportingController < BaseController
                ...
                # or contains data that the Web UI user should not see that was altered on the Web
                # UI with the visibility filter.
                #
                # @param topic_id [String]
                # @param partition_id [Integer]
